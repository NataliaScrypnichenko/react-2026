...
тут научусь натискати на користувача витягувати інформацію про нього а на кнопку про пости його,
щоб використати і витягнути userId із щляху то використовуємо хук
userParams()
